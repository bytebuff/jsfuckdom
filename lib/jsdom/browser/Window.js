...
function setupWindow(windowInstance, { runScripts }) {
  ...
  // fix jsfuckdom window.constructor toString
  Object.defineProperties(windowPrototype.constructor, {
    toString: {
      value() {
...
function Window(options) {
  ...
  this._jsfuckResourceLoader = options.resourceLoader;
  ...
  // fix jsfuckdom toString for HTMLDocument
  Object.defineProperties(this._document, {
  ...
  this._jsfuckSessionHistory = new SessionHistory({
  ...
  const navigator = Navigator.create(window, [], { userAgent: this._jsfuckResourceLoader._userAgent });
